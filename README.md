...
* `bleeding`, daily bleeding edge version of Horizon 22 using OpenJDK 8u151-jdk
* `21.0.2-1`, `latest` is a reference to last stable release of Horizon using OpenJDK 8u151-jdk
